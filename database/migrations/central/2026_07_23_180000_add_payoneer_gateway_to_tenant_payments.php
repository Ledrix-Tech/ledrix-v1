...
return new class extends Migration
{
    ...
    {
        DB::connection('central')->statement(
            "ALTER TABLE tenant_payments MODIFY COLUMN gateway ENUM('stripe', 'manual') NOT NULL DEFAULT 'stripe'"
        );

        DB::connection('central')->statement(
            "ALTER TABLE tenant_payments MODIFY COLUMN renewed_by ENUM('stripe', 'super_admin', 'tenant') NOT NULL DEFAULT 'stripe'"
        );
    }
};
