...
@section('title', 'Sign in | Client Portal')
...
@section('auth-content')
    <div class="crm-auth-page">
        <div class="crm-auth-card">
            ...
            <h1>Client Portal</h1>
            <p class="crm-auth-sub">Sign in to view your projects, invoices, and briefs.</p>
            ...
            <form action="{{ route('client.login.post') }}" method="post">
                ...
                <div class="d-flex justify-content-end mb-3">
                    <a href="{{ route('client.forgot.get') }}">Forgot password?</a>
                </div>
