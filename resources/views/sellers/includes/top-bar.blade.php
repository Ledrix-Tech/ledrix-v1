@php
    ...
    $homeRoute = route('seller.index.get');
@endphp
<header class="crm-topbar">
    <div class="d-flex align-items-center gap-2">
        ...
        <a href="{{ $homeRoute }}" class="crm-topbar-brand">
            ...
            <span class="crm-topbar-badge d-none d-sm-inline">Seller Portal</span>
        </a>
    </div>
    ...
    <div class="crm-topbar-actions">
        ...
        <div class="dropdown">
            <button class="crm-user-btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <span class="d-none d-sm-inline">{{ ucfirst($user->name ?? 'Seller') }}</span>
            </button>
