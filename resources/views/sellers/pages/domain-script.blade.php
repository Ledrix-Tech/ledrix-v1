        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="heading d-flex justify-content-between">
                    <h1 class="fw-bold" style="color: #003C51;">Lead Scripts</h1>
                    <div class="d-flex">
                        <div class="d-flex">
                ...
                @if ($brand ?? null)
                    <p class="text-muted mb-0">
                        ...
                        @if (empty($companyApiKey))
                            <span class="badge badge-warning ms-2">API key unavailable — contact admin</span>
                        @endif
                    </p>
                @endif
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <textarea id="lead_script" name="lead_script" class="code-editor form-control">
<script>
    (function() {
